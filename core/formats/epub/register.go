...
func (h *embeddedHandler) ExtractIR(path, outputDir string) (*plugins.ExtractIRResult, error) {
	// TODO: Implement EPUB to IR conversion
	return nil, fmt.Errorf("EPUB IR extraction not yet implemented in canonical package")
}

func (h *embeddedHandler) EmitNative(irPath, outputDir string) (*plugins.EmitNativeResult, error) {
	// TODO: Implement IR to EPUB conversion
	return nil, fmt.Errorf("EPUB native emission not yet implemented in canonical package")
}
