// Package txt handles plain text Bible format.
...
func detectTXT(path string) (*ipc.DetectResult, error) {
...
func parseTXT(path string) (*ir.Corpus, error) {
	data, err := os.ReadFile(path)
	if err != nil {
