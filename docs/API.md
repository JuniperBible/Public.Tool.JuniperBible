...
This document provides an overview of the main packages and types in Capsule Lab.

## REST API

The Capsule Lab REST API provides HTTP endpoints for managing capsules, converting formats, and querying plugins.
