...
// Plugin format-morphgnt handles MorphGNT Greek NT format using the SDK pattern.
...
// detectMorphGNT checks if the file is in MorphGNT format
...
// parseMorphGNT converts MorphGNT format to IR
...
// emitMorphGNT converts IR back to MorphGNT format
