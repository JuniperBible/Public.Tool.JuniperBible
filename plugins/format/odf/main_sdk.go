...
// detectODF checks if the file is a valid ODF file
...
// enumerateODF lists the contents of an ODF file
...
// parseODF converts ODF Bible format to IR
...
// parseODFContent extracts content from ODF XML
...
// emitODF converts IR back to ODF Bible format
...
// generateODF creates an ODF file from a corpus
