...
// Plugin format-tar handles TAR archive ingestion using the SDK pattern.
// It detects tar, tar.gz, tar.xz files and can enumerate contents.
//
// Archive Support:
// - detect: Identifies TAR archives by extension and magic bytes
// - ingest: Stores TAR archive as blob with metadata
...
// detectTar checks if the file is a TAR archive
...
// detectCompression determines compression type from file path and data
...
// enumerateTarEntries reads all entries from a TAR archive
